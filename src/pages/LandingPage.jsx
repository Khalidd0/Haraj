      ...
      <div className="text-center space-y-6 max-w-3xl mx-auto px-4">
        ...
        {rules.length > 0 && (
          <div className="card p-4 text-left space-y-2">
            <div className="text-sm font-semibold">Marketplace rules & announcements</div>
            {rules.map(rule => (
              <div key={rule.id || rule._id} className="text-xs border-t pt-2 first:border-t-0 first:pt-0">
